...
public class Manager {
	...
	/*This function removes the tmpMember from MembersAndDeliveries1,2 TreeMaps,only if the member is found in the TreeMaps*/
	 public void removeMemberFromMembersAndDeliveriesMaps(Members tmpMember)
	 {
		 ...
		 if(DataBase.ourMembersAndDeliveries1.containsValue(tmpMember))
		 {
